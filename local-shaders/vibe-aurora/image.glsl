...
const vec3 COLOR_SHADOW = vec3(0.031, 0.071, 0.176);

// Secondary tint mixed into the mid band gradient
const vec3 COLOR_MID = vec3(0.102, 0.549, 0.608);

// Highlight accent applied during the pulse
const vec3 COLOR_HILITE = vec3(0.706, 1, 0.965);

// Blend ratio between base and highlight colours
const float BLOOM_BLEND = 0.7;

// Angular band count around the centre
const float STRIPE_FREQUENCY = 5.8;

// Controls how sharp the angular bands appear
const float STRIPE_CURVE = 1.5;
