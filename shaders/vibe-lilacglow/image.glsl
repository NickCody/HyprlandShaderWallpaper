...
const vec3 COLOR_SHADOW = vec3(0.137, 0.078, 0.235);

// Secondary tint mixed into the mid band gradient
const vec3 COLOR_MID = vec3(0.471, 0.314, 0.863);

// Highlight accent applied during the pulse
const vec3 COLOR_HILITE = vec3(0.804, 0.706, 1);

// Blend ratio between base and highlight colours
const float BLOOM_BLEND = 0.62;

// Angular band count around the centre
const float STRIPE_FREQUENCY = 7;

// Controls how sharp the angular bands appear
const float STRIPE_CURVE = 1.3;
