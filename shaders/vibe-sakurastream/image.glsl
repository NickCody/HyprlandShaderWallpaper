...
const float VIGNETTE_POWER = 2.1;

// Blend amount for vignette application
const float VIGNETTE_MIX = 0.52;

// Strength of the animated grain
const float GRAIN_AMOUNT = 0.013;
// ---------------------------------------------------------------------------
